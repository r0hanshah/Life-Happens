    ...
    return (
      <View style={{flexDirection:"column", alignItems:"center"}}>
        ...
        <View style={{flexDirection: "row", justifyContent: "flex-start", width: "100%"}}>
          ...
          <View style={{width: 2, height: leafTasks.length > 0 ? windowHeight*0.044 + leafTasks[0].offset * 4 + 1 : 33, backgroundColor:leafTasks.length > 0 ? leafTasks[0].color : "rgba(255,255,255,0)", marginRight: 3}}/>
          ...
          <View style={{width: 2, height: leafTasks.length > 1 ? windowHeight*0.044 + leafTasks[1].offset * 4 + 1 : 33, backgroundColor:leafTasks.length > 1 ? leafTasks[1].color : "rgba(255,255,255,0)", marginRight: 3}}/>
          <View style={{width: 2, height: 37, backgroundColor:"rgba(255,255,255,0)", marginRight: 8}}/>

          <View style={{width: 2, height: 30, backgroundColor:"rgba(255,255,255,0)", marginRight: 3}}/>
          <View style={{width: 2, height: leafTasks.length > 2 ? windowHeight*0.044 + leafTasks[2].offset * 4 + 1 : 33, backgroundColor:leafTasks.length > 2 ? leafTasks[2].color : "rgba(255,255,255,0)", marginRight: 3}}/>
