...
const WireFrame: React.FC<Tasks> = ({ tasks }) => {
    return (
        <View style={styles.container}>
            <GridComponent offset={0} subtaskDispIds={["red,lol|||loll===0,2,1,1", "green,lol|||loll===2,2,3,0", "purple,lol|||loll===3,2:::loll===2,3,3,0"]} />
            ...
            <ParentNodeGridComponent offset={0} parentNodes={['0,0,red', '3,1,purple']}/>
