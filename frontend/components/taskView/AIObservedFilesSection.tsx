...
const AIObservedFilesSection: React.FC<{task: TaskModel, isLeft: Boolean, fontsLoaded: boolean, mainController: MainController}> = ({task, isLeft, fontsLoaded, mainController}) => {
...
export default AIObservedFilesSection;